...
import its.nugrohodimas.runningapp.helper.Constants.MAP_ZOOM
import its.nugrohodimas.runningapp.helper.Constants.POLYLINE_COLOR
import its.nugrohodimas.runningapp.helper.Constants.POLYLINE_WIDTH
import its.nugrohodimas.runningapp.helper.TrackingUtility
import its.nugrohodimas.runningapp.service.Polyline
...
class TrackingFragment : Fragment(R.layout.fragment_tracking) {
    ...
    private fun showCancelTrackingDialog() {
        val dialog = MaterialAlertDialogBuilder(requireContext(), R.style.AlertDialogTheme)
            ...
            .setMessage("Are you sure cancel the run?")
